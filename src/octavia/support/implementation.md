...
<table>
	<thead>
		<tr>
			...
			<th rowspan=2 title="Recognized">Rx</th>
			<th rowspan=2 title="Transmitted">Tx</th>
	...
	<tbody>
		...
		<tr>
			...
			<td>MIDI 1.0<br/>Note on</td>
			<td>✓ <code>9n vv</code></td>
			<td>✕</td>
			<td><code>vv</code>=<code>01 00</code>-<code>7f 7f</code> (<code>0x0080</code>-<code>0x3fff</code>)</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>MIDI 1.0<br/>Note</td>
			<td>✓</td>
			<td>✕</td>
			<td>Same as <i>Note On</i>.</td>
		</tr>
		<tr>
			<td>MIDI 1.0<br/>Channel</td>
			<td>✓</td>
			<td>✕</td>
			<td>Same as <i>Note On</i>.</td>
		</tr>
		...
		<tr>
			<td rowspan=70>Control Change</td>
			<td>0</td>
			<td>✓</td>
			<td>✕</td>
